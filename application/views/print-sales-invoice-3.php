...
@page { size: A5 landscape margin: 5px; }
body { margin: 5px; }
...
<?php
    ...
    if(!empty($res3->shippingaddress_id)){
      ...
      $q4=$this->db->query("select * from db_users where status=1 and store_id=".get_current_store_id());
      $res4=$q4->row();
      
      $user_name=$res4->username;
...
<table autosize="1" style="overflow: wrap" id='mytable' align="center" width="100%" height='100%'  cellpadding="3" cellspacing="0"  >
<!-- <table align="center" width="100%" height='100%'   > -->
    ...
    <thead>
      ...
      <tr>
        <th colspan="16">
          <table width="100%" height='100%' cellpadding="7" class="style_hidden fixed_table">
              <tr>
                <!-- First Half -->
                <td colspan="4">
...
<!-- backup table head row
      <tr class="bg-sky" style="border: 0.5px solid#9a9a9a">  < Colspan 10 >
...
-->
      ...
      <tr class="bg-sky" style="border: 0.5px solid#9a9a9a"><!-- Colspan 10 -->
        ...
        <th colspan='2' class="text-center"><?= $this->lang->line('disc.'); ?></th>
        <th colspan='2' class="text-center"><?= $this->lang->line('amount'); ?></th>
      </tr>
 ...
 <?php
         ...
         //         echo "<td colspan='1' class='text-right'>".store_number_format($res2->tax)."%</td>";
            //      echo "<td style='text-align: right;'>".store_number_format($res2->tax_amt)."</td>"; 
                  ...
                  echo "<td colspan='2' style='text-align: center;'>".store_number_format($discount_amt)."</td>";
...
<tfoot>
  ...
  <tr class="bg-sky" style="border: 0.5px solid#9a9a9a">
    <td colspan="8" class='text-right text-bold'><?= $this->lang->line('total'); ?></td>
    <td colspan="2" class='text-center' ><b><?php echo store_number_format($tot_sales_price); ?></b></td>
...
<!--     <td colspan="1" class='text-bold text-center'></td>
   <td colspan="1" class='text-right' ><b><?php echo store_number_format($tot_tax_amt); ?></b></td> -->
    <td colspan="2" class='text-center' ><b><?php echo store_number_format($tot_discount_amt); ?></b></td>
  ...
  <tr>
    ...
    <td colspan="2" class='text-center' ><b><?php echo store_number_format($other_charges_amt); ?></b></td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="2" class='text-center' ><b><?php echo store_number_format($tot_discount_to_all_amt); ?></b></td>
  </tr>
  
  <tr>
    <td colspan="14" class='text-right'><b><?= $this->lang->line('grand_total'); ?></b></td>
    <td colspan="2" class='text-center' ><b><?php echo store_number_format($grand_total); ?></b></td>
  </tr>
...
<?php } ?>
  ...
  <tr>
      <td colspan="16">
      <?php
        echo "<span class='amt-in-word'>Created By : <i style='font-weight:bold;'>$user_name</i></span>";
      ?>
    </td>
  </tr>
