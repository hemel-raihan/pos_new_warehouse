...
<table autosize="1" style="overflow: wrap" id='mytable' align="center" width="1024px" height='100%'  cellpadding="0" cellspacing="0"  >
<!-- <table align="center" width="100%" height='100%'   > -->
    ...
    <thead>
                ...
                <td colspan="8" rowspan="1">
                  <span>
                    <table style="width: 100%;" class="style_hidden fixed_table">
                        ...
                        <tr>
                          <td colspan="8">
                            <span style="font-size: 25px;"> Invoice No. 
      ...
      <tr class="bg-sky"><!-- Colspan 10 -->
        <th colspan='2' class="text-center" style='border:0.5px solid#c3c3c3;'><?= $this->lang->line('sl_no'); ?></th>
        <th colspan='4' class="text-center" style='border:0.5px solid#c3c3c3;'><?= $this->lang->line('description_of_goods'); ?></th>
        <th colspan='2' class="text-center" style='border:0.5px solid#c3c3c3;'><?= $this->lang->line('hsn'); ?></th>
        <th colspan='2' class="text-center" style='border:0.5px solid#c3c3c3;'><?= $this->lang->line('unit_cost'); ?></th>
        <th colspan='1' class="text-center" style='border:0.5px solid#c3c3c3;'><?= $this->lang->line('qty'); ?></th>
        <th colspan='1' class="text-center" style='border:0.5px solid#c3c3c3;'><?= $this->lang->line('tax'); ?></th>
        <th colspan='1' class="text-center" style='border:0.5px solid#c3c3c3;'><?= $this->lang->line('tax_amt'); ?></th>
        <th colspan='1' class="text-center" style='border:0.5px solid#c3c3c3;'><?= $this->lang->line('disc.'); ?></th>
        <!-- <th colspan='2' class="text-center"><?= $this->lang->line('rate'); ?></th> -->
        <th colspan='2' class="text-center" style='border:0.5px solid#c3c3c3;'><?= $this->lang->line('amount'); ?></th>
      </tr>
  </thead>
...
<tbody>
 ...
 <?php
              ...
              foreach ($q2->result() as $res2) {
                  ...
                  echo "<tr>";  
                  echo "<td colspan='2' class='text-center' style='border:0.5px solid#c3c3c3;'>".$i++."</td>";
                  echo "<td colspan='4'style='border:0.5px solid#c3c3c3;'>";
                  echo $res2->item_name;
                  echo (!empty($res2->description)) ? "<br><i>[".nl2br($res2->description)."]</i>" : '';
                  echo "</td>";
                  echo "<td colspan='2' class='text-left'style='border:0.5px solid#c3c3c3;'>".$res2->hsn."</td>";
                  echo "<td colspan='2' class='text-right'style='border:0.5px solid#c3c3c3;'>".store_number_format($res2->price_per_unit)."</td>";
                  
                  echo "<td class='text-center'style='border:0.5px solid#c3c3c3;'>".$res2->sales_qty."</td>";
                  echo "<td colspan='1' class='text-right'style='border:0.5px solid#c3c3c3;'>".store_number_format($res2->tax)."%</td>";
                  echo "<td style='text-align: right; border:0.5px solid#c3c3c3;'>".store_number_format($res2->tax_amt)."</td>";
                  //echo "<td style='text-align: right;'>".$discount."</td>";
                  echo "<td style='text-align: right; border:0.5px solid#c3c3c3;'>".store_number_format($discount_amt)."</td>";
 
                  //echo "<td colspan='2' class='text-right'>".number_format($before_tax,2)."</td>";
                  //echo "<td class='text-right'>".$res2->price_per_unit."</td>";
                  
                  echo "<td colspan='2' class='text-right'style='border:0.5px solid#c3c3c3;'>".store_number_format($res2->total_cost)."</td>";
                  echo "</tr>";  
...
<tfoot>
  ...
  <tr class="bg-sky">
    <td colspan="8" class='text-center text-bold' style='border:0.5px solid#c3c3c3;'><?= $this->lang->line('total'); ?></td>
    <td colspan="2" class='text-right' style='border:0.5px solid#c3c3c3;' ><b><?php echo store_number_format($tot_sales_price); ?></b></td>
    <td colspan="1" class='text-bold text-center' style='border:0.5px solid#c3c3c3;'><?=number_format($tot_qty,2); ?></td>
    <td colspan="1" class='text-bold text-center' style='border:0.5px solid#c3c3c3;'></td>
    <td colspan="1" class='text-right' style='border:0.5px solid#c3c3c3;' ><b><?php echo store_number_format($tot_tax_amt); ?></b></td>
    <td colspan="1" class='text-right' style='border:0.5px solid#c3c3c3;'><b><?php echo store_number_format($tot_discount_amt); ?></b></td>
    <td colspan="2" class='text-right' style='border:0.5px solid#c3c3c3;'><b><?php echo store_number_format($tot_total_cost); ?></b></td>
  </tr>
 
 <table style="float: right;width: 500px;border: 0.5px solid#000;">
  <tr>
    <td colspan="14" class='text-right' style="border: 0.5px solid#ccc5c5;"><b><?= $this->lang->line('subtotal'); ?></b></td>
    <td colspan="2" class='text-right' style="border: 0.5px solid#ccc5c5;" ><b><?php echo store_number_format($tot_total_cost); ?></b></td>
  </tr>


  <tr>
    <td colspan="14" class='text-right' style="border: 0.5px solid#ccc5c5;"><b><?= $this->lang->line('other_charges'); ?></b></td>
    <td colspan="2" class='text-right' style="border: 0.5px solid#ccc5c5;"><b><?php echo store_number_format($other_charges_amt); ?></b></td>
  </tr>
  
  <?php if(!empty($coupon_code)){ ?>
  <tr>
    <td colspan="6" class='text-left' style="border: 0.5px solid#ccc5c5;"><b>
      <?= $this->lang->line('couponCode'); ?> : <?=getTruncatedCCNumber($coupon_code);?>
    </b>
    </td>
    <td colspan="8" class='text-right' style="border: 0.5px solid#ccc5c5;"><b>
      <?= $this->lang->line('couponDiscount'); ?> <?= ($coupon_type=='Percentage') ? $coupon_value .'%' : '[Fixed]' ;?>
    </b>
    </td>
    <td colspan="2" class='text-right'style="border: 0.5px solid#ccc5c5;" ><b><?= store_number_format($res3->coupon_amt); ?></b></td>
  </tr>
  <?php } ?>
  <tr>
    <td colspan="14" class='text-right'style="border: 0.5px solid#ccc5c5;"><b><?= $this->lang->line('discount_on_all'); ?>(<?= store_number_format($discount_to_all_input)." ".$discount_to_all_type; ?>)</b></td>
    <td colspan="2" class='text-right'style="border: 0.5px solid#ccc5c5;" ><b><?php echo store_number_format($tot_discount_to_all_amt); ?></b></td>
  </tr>
  
  <tr>
    <td colspan="14" class='text-right'style="border: 0.5px solid#ccc5c5;"><b><?= $this->lang->line('grand_total'); ?></b></td>
    <td colspan="2" class='text-right'style="border: 0.5px solid#ccc5c5;" ><b><?php echo store_number_format($grand_total); ?></b></td>
  </tr>

  <?php if($previous_balance_bit==1){ ?>
  <tr>
    <td colspan="14" class='text-right text-italic'style="border: 0.5px solid#ccc5c5;"><?= $this->lang->line('previous_balance'); ?></td>
    <td colspan="2" class='text-right'style="border: 0.5px solid#ccc5c5;" ><?php echo store_number_format($previous_due); ?></td>
  </tr>
  <tr>
    <td colspan="14" class='text-right text-italic'style="border: 0.5px solid#ccc5c5;"><?= $this->lang->line('total_due'); ?></td>
    <td colspan="2" class='text-right' style="border: 0.5px solid#ccc5c5;"><?php echo store_number_format($total_due); ?></td>
  </tr>  
  <?php } ?>
</table>
